...
import { BeatCard, type BeatCardProps } from './BeatCard';
...
export const MeasureGroup: React.FC<MeasureGroupProps> = ({
  ...
  return (
    <div className="flex flex-col gap-1 relative">
      {/* Bar Number Header */}
      <div className="text-xs text-gray-500 font-mono pl-1">BAR {measure.index}</div>
      ...
      <div className="flex gap-1 bg-gray-900 p-1 rounded-xl border border-gray-800">
        {measure.beats.map((beat, i) => {
          ...
          return React.createElement(BeatCard, {
            key: beat.id,
